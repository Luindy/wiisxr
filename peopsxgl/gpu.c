...
void sysdep_create_display(void)                       // create display
{
 ...
 //TODO Needs to be fully ported to GLU from X11
 glutInit(NULL, NULL);
...
long PEOPS_GPUclose()                                        // LINUX CLOSE
{
 GLcleanup();                                          // close OGL
...
long CALLBACK PEOPS_GPUshutdown()
{
...
void CALLBACK PEOPS_GPUupdateLace(void)
{
...
uint32_t CALLBACK PEOPS_GPUreadStatus(void)
{   
...
void CALLBACK PEOPS_GPUwriteStatus(uint32_t gdata)
{
...
long CALLBACK PEOPS_GPUfreeze(uint32_t ulGetFreezeData,GPUFreeze_t * pF)
{
 ...
 PEOPS_GPUwriteStatus(ulStatusControl[8]);
...
////////////////////////////////////////////////////////////////////////
void CALLBACK PEOPS_GPUdisplayText(char * pText){
 //TODO
}
